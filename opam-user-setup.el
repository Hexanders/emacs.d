...
;; ## added by OPAM user-setup for emacs / tuareg ## 4601c7f115e4c8689bbae3992cb70a14 ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/home/Kononov/.opam/default/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
